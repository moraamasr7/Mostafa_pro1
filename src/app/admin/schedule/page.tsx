...
export default function AdminSchedulePage() {
  ...
  const fetchScheduleData = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // ترتيب الأيام من الأحد (0) إلى السبت (6) وتجهيز القيم الافتراضية
  ...
  useEffect(() => {
    ...
    // Realtime channel لتحديث شاشة الجدول فورياً
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 flex-1 w-full space-y-6">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            {/* الجدول الدوري الأسبوعي (Weekly Operating Hours) */}
            ...
            {/* العطلات والمواعيد الاستثنائية (Closures & Overrides) */}
            <div className="lg:col-span-5 space-y-6">
              {/* قسم العطلات والإغلاقات الاستثنائية */}
              <div className="bg-white p-5 rounded-3xl border border-gray-200 shadow-sm space-y-4">
                ...
                <form onSubmit={handleAddClosure} className="space-y-3">
                  <div className="flex gap-2">
                    ...
                    <input
                      type="text"
                      placeholder="سبب الإغلاق (مثال: عيد الأضحى)..."
                      value={closureReason}
              ...
              {/* قسم المواعيد الاستثنائية والتجاوزات */}
              <div className="bg-white p-5 rounded-3xl border border-gray-200 shadow-sm space-y-4">
                <h2 className="text-sm font-extrabold text-gray-900">
                ...
                <form onSubmit={handleAddOverride} className="space-y-3">
                  ...
                  <label className="flex items-center gap-2 text-xs text-gray-700 font-bold px-1">
                    ...
                    />
                    <span>إغلاق كلي بهذا اليوم (تجاوز الإعادة)</span>
                  </label>
