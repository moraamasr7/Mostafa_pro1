...
export default function ShiftControlCenterPage() {
  ...
  const fetchControlCenterData = async () => {
    ...
    try {
      ...
      if (ordersRes.ok && driversRes.ok && tripsRes.ok) {
        ...
        // 3. معالجة قائمة الطيارين ورحلاتهم وسعتهم الحالية (حتى 5)
  ...
  useEffect(() => {
    ...
    // Realtime Channel شامل لمركز التحكم في الوردية
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-900 flex flex-col font-sans">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 flex-1 w-full space-y-6">
        ...
        {/* 1. ملخص الوردية اللحظية (SHIFTS SUMMARY BANNER) */}
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            {/* 2. قسم الطلبات النشطة للوردية (ACTIVE ORDERS) */}
            ...
            {/* 3. قسم طاقم الطيارين وخطوط السير الحالية (DRIVER OPERATIONS & TRIPS) */}
            <div className="lg:col-span-5 space-y-6">
              {/* جدول تشغيل الطيارين والسعة */}
                  ...
                  {drivers.map((d) => (
                    ...
                    >
                      <div>
                        ...
                        <span className="text-[11px] text-gray-500 font-semibold dir-ltr block">
                          📞 {d.phone}
                        </span>
                      </div>
              ...
              {/* جدول خطوط سير الدليفري الحالية (DELIVERY TRIPS OVERVIEW) */}
              <div className="bg-white p-5 rounded-3xl border border-gray-200 shadow-sm space-y-3">
                <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                  <h3 className="text-sm font-black text-gray-900 flex items-center gap-2">
