...
export default function DriverMobilePage() {
  ...
  // النوافذ المنبثقة للتحصيل أو الفشل
  ...
  useEffect(() => {
    ...
    // Realtime channel لمزامنة شاشة الطيار فورياً
  ...
  // تسجيل دخول الطيار برقم الموبايل
  ...
  // تأكيد تسليم طلب فردي + المبلغ المحصل
  ...
  // تأكيد فشل توصيل طلب فردي + السبب
  ...
  // إنهاء الرحلة بالكامل بعد حسم كل الطلبات
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white flex flex-col font-sans pb-10">
      ...
      {/* نافذة تأكيد التحصيل والتسليم (Collection Modal) */}
      ...
      {/* نافذة تسجيل سبب عدم التوصيل (Failure Reason Modal) */}
